...
exports.subscriptionConfiguration = {
  changeType: 'Created',
  notificationUrl: (process.env.NODE_ENV=='production') ? 'https://get-vultured.herokuapp.com/listen' : 'https://19b31d24.ngrok.io/listen',
  resource: 'me/mailFolders(\'Inbox\')/messages',
  clientState: process.env.CLIENT_STATE || 'testSecreT'
};
